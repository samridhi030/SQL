...
insert into worker_table VALUES( 109, 'roy' ,'anderson', 34000 , 'supply chain', 33);
insert into worker_table VALUES( 110, 'holly' ,'flax', 65000 , 'hr', 35);
insert into worker_table VALUES( 111, 'vipul' ,'singh', 86000 , 'IT', 33);
insert into worker_table VALUES( 112, 'satish' ,'sharma', 80000 , 'IT', 32);
select * from worker_table

1.
select * from worker_table where not first_name='vipul' and not first_name= 'satish';
